...
public class PlayerShip extends MoveableObject {
     ...
     */
    public PlayerShip (Point location, Point speed, int strength, int health, BufferedImage img, String name) {
    ...
    public void draw(Graphics g, ImageObserver observer) {
    	if (isDead) return;
    	if(respawnCounter<=0)
    		g.drawImage(getImg(), super.getLocation().x, super.getLocation().y, observer);
    ...
    /**
     * Sets the isFiring flag to start firing
     */
    public void startFiring(){
    	isFiring=true;
    }
    /**
     * Unsets the isFiring flag to stop firing
     */
    ...
    /**
     * 
     * @return The lives left for the PlayerShip
     */
    public int getLives(){
    	return this.lives;
    }
    /**
     * 
     * @return The score of the PlayerShip
     */
    public int getScore(){
    	return this.score;
    }
    /**
     * 
     * @return The name of the Playership
     */
    ...
    /**
     * Test if the PlayerShip is moving
     * @return If the up or down flag is set, returns true; otherwise returns false
     */
	...
	/**
	 * Sets the location of the PlayerShip
	 */
	public void setLocation(Point loc) {
		super.setLocation(loc);
	}
	/**
	 * Add score to the Playership
	 * @param score The score points to add
	 */
	public void addScore(int score) {
		this.score += score;
	}
	/**
	 * Test if the player is respawning
